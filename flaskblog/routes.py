...
def account():
    ...
    if form.validate_on_submit():
        if form.picture.data:
            prev_pic_path = os.path.join(app.root_path, 'static/profile_pics', current_user.image_file)
...
def profile(user_id):
    ...
    return render_template('profile.html', title=user.username, user=user, image_file=image_file, posts=posts)
...
def send_reset_email(user):
    ...
    msg = Message('Password reset request', sender='weifutao@yeah.net', recipients=[user.email])
